...
class AppEnv {
  ...
  static const personality = String.fromEnvironment('PERSONALITY', defaultValue: 'minimal');

  /// One of: fullbleed | split | centered | video_bg
  static const heroVariant = String.fromEnvironment('HERO_VARIANT', defaultValue: 'fullbleed');
  ...
  static const colorPrimary = String.fromEnvironment('COLOR_PRIMARY', defaultValue: '6750A4');
  static const colorSecondary = String.fromEnvironment('COLOR_SECONDARY', defaultValue: '625B71');
  static const colorAccent = String.fromEnvironment('COLOR_ACCENT', defaultValue: '7D5260');
  static const colorSurface = String.fromEnvironment('COLOR_SURFACE', defaultValue: 'FFFBFE');
  static const colorOnSurface = String.fromEnvironment('COLOR_ON_SURFACE', defaultValue: '1C1B1F');
  ...
  // ─── Fonts ───────────────────────────────────────────────────────────────
  static const fontPrimary = String.fromEnvironment('FONT_PRIMARY', defaultValue: 'Inter');
  static const fontSecondary = String.fromEnvironment('FONT_SECONDARY', defaultValue: 'Inter');
