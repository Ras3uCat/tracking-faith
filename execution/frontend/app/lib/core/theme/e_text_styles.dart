...
class ETextStyles {
  ...
  static TextStyle get h3 => _secondary(size: 20 * _hs, weight: FontWeight.w600, height: 1.3);
  ...
  static TextStyle get overline =>
      _secondary(size: 11, weight: FontWeight.w600, letterSpacing: 2.0, color: EColors.primary);
  ...
  static TextStyle get button => _secondary(size: 14, weight: FontWeight.w600, letterSpacing: 0.8);

  static TextStyle get navItem => _secondary(size: 14, weight: FontWeight.w500, letterSpacing: 0.3);
